...
namespace ScreenshotInterface
{
    ...
    public class UpdateGraphics : MarshalByRefObject
    {
        Image _img;
        Guid _requestId = Guid.NewGuid();
        public UpdateGraphics(Image img)
        {
            _img = img;
        }
    ...
    public class ScreenshotInterface : MarshalByRefObject
    {
        ...
        public byte[] GetUpdateRequest(Int32 clientPID)
        {
            return ScreenshotManager.GetUGRequest(clientPID);
        }
