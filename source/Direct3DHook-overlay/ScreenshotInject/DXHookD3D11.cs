...
namespace ScreenshotInject
{
    ...
    internal class DXHookD3D11: BaseDXHook
    {
        ...
        Image imag;
        SlimDX.Direct3D11.Texture2D tx;

        public DXHookD3D11(ScreenshotInterface.ScreenshotInterface ssInterface) : base(ssInterface) {  }
        ...
        /*
        private static IntPtr globalSwapChainPtr = IntPtr.Zero;
        private static int globalSyncInterval = 0;
        private static SlimDX.DXGI.PresentFlags globalFlags = 0;
        Timer globalTimer = new Timer(TimerCallback, null, 0, 1000);

        private static void TimerCallback(Object o)
        {
            if (globalSwapChainPtr != IntPtr.Zero)
            {
                SwapChain swapChain = _swapChain;
                int t = swapChain.Present(globalSyncInterval, globalFlags).Code;
            }
        } */
