...
#End Region
    ...
    Sub New(ByVal modifier As Modifier, ByVal key As Keys)
        ...
        'If Not RegisterHotKey(Handle, ID, modifier, key) Then Exit Sub
    ...
    Sub Register()
        If Not RegisterHotKey(Handle, ID, EventArgs.Modifier, EventArgs.Key) Then Throw New RegisteredException
    End Sub
